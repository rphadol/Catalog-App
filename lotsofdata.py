...
User1 = User(name="Vira ", email="angel@udacity.com",
             picture='https://pbs.twimg.com/profile_images/2671170543/18de  \
                      bd694829ed78203a5a36dd364160_400x400.png')
session.add(User1)
session.commit()
...
Item1 = Items(name="Stick",
              ...
              description="Built with 70% carbon construction.",
              category_id=1,
              user_id=1)
session.add(Item1)
session.commit()
...
Item3 = Items(name="Hockey Socks",
              date=datetime.datetime.now(),
              description="socks are made of Cotton/Polyester blend,",
              category_id=1,
              user_id=1)
session.add(Item3)
session.commit()
